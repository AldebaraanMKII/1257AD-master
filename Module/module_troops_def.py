...
mamluke_elite_gear = [itm_arab_helmet_c,itm_arab_helmet_b,itm_arab_mail_coif,itm_mamluke_helm_b,itm_arab_helmet_d,itm_mail_mittens,itm_sarranid_boots_d]
...
maghreb_vet_gear = [itm_sarranid_mail_coif,itm_sarranid_horseman_helmet,itm_african_spangen,itm_megreb_spangen,itm_faris_helmet,itm_kufia_berber_black,itm_leather_gloves,itm_sarranid_boots_b]

maghreb_elite_gear = [itm_kufia_berber_black,itm_kufia_berber_black,itm_kufia_berber_black,itm_kufia_berber_black,itm_kufia_berber_black,itm_berber_white_turban,itm_berber_helmet_g,itm_mail_mittens,itm_sarranid_boots_d]
...
welsh_elite_gear = [itm_maciejowski_kettle_hat_a,itm_maciejowski_kettle_hat_b,itm_maciejowski_kettle_hat_a,itm_maciejowski_kettle_hat_b,itm_maciejowski_kettle_hat_a,itm_maciejowski_kettle_hat_b,itm_modded_helmet_kettle_mail_4,itm_modded_helmet_kettle_mail_5,itm_mail_mittens,itm_kau_mail_boots_dark]
...
kern_elite_gear = [itm_kettle_cloth_cape,itm_kettle_cloth_cape_b,itm_kettle_cloth_cape,itm_kettle_cloth_cape_b,itm_kettle_cloth_cape,itm_kettle_cloth_cape_b,itm_kettlehat_d,itm_kettlehat_e,itm_mail_mittens,itm_kau_mail_boots_dark]
#############
