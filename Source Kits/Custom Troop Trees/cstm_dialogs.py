...
restart_customisation_dialogs = [
    ...
    # [anyone|plyr, "dplmc_constable_recruits_and_training",
        ...
        # ],
        # "I'd like to customise our kingdom's troops.", "cstm_dplmc_constable_customise_tree_ask_2",
        # []
    # ],
    
    [anyone, "cstm_dplmc_constable_customise_tree_ask_2",
        [],
...
def modmerge(var_set):
    try:
        ...
        orig_dialogs[index:index] = restart_customisation_dialogs
