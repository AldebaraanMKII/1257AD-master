...
######################### NEW v2.1 MUSIC
  ("NewBattle1", "(Arabic_Battle_1)_Crack_your_head_with_a_Tabla.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_ambushed|mtf_culture_all, 0),
  ("NewBattle2", "(Crusades_Battle)_Valley_Of_Death.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_ambushed|mtf_culture_all, 0),
  ("NewBattle3", "(Euro_Battle_1)_Duke_of_Death.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_ambushed|mtf_culture_all|mtf_sit_siege, 0),
  ("NewBattle5", "(Teutonic_Battle)_Darker_Skies_Ahead.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_ambushed|mtf_culture_all, 0),
  ("NewBattle6", "06-melee-cafe.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_ambushed|mtf_culture_all, 0),
  ("NewBattle7", "12-mayhem.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_ambushed|mtf_culture_all, 0),
  ("NewBattle8", "13-imperial-conflict.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_ambushed|mtf_culture_all, 0),
  ("NewBattle9", "16-the-enemy-is-near.mp3", mtf_module_track|mtf_sit_fight|mtf_sit_ambushed|mtf_culture_all, 0),
  ...
  ("NewBattle18", "10-time-2-kill.mp3", mtf_module_track|mtf_sit_ambushed|mtf_culture_all|mtf_sit_encounter_hostile, 0),
