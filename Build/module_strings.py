...
("ee_culture_title_baltic", "Kunigas {s0}"),
...
("ee_culture_title_crusader", "Lord {s0}"),    ###### NEW v3.3
("ee_culture_title_cuman", "Chieftain {s0}"),    ###### NEW v3.3
...
("ee_language_title_baltic", "Kunigas {s0}"),
...
("ee_language_title_cuman", "Chieftain {s0}"),   ###### NEW v3.3
...
("ee_language_title_king_cuman", "Khan {s0}"),  ###### NEW v3.3
