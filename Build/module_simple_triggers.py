   ...
   (try_for_range, ":merchant", traders_begin, traders_end),
      ...
      (try_begin), ### HATS!
        ...
        (try_for_range, reg0, 0, 30),
          ...
          (store_random_in_range, ":itm_2", "itm_nomad_cap", "itm_wooden_shield"), ### Removed weird items (NEW v3.9.3, by Khanor) ###
          (troop_add_item, ":merchant", ":itm_2"),
        (try_end),
      (else_try), ### Swords
...
####
# (24,   
(0.21,  ######## once a day for every one of the 112 horse merchants   
[
########## NEW v3.8 - horse merchants and constable train or heal horses
  (try_begin),
    (eq, "$g_cur_horse_merchant", "trp_dplmc_constable"), 
      (assign, "$g_cur_horse_merchant", horse_merchants_begin),
  (try_end),
  
  (try_begin),
    (lt, "$g_cur_horse_merchant", horse_merchants_begin), 
      (assign, "$g_cur_horse_merchant", horse_merchants_begin),
  (try_end),
...
############ - horse merchants
  (try_begin),
    (troop_slot_ge, "$g_cur_horse_merchant", slot_troop_horse_train_cur_horse, 1),
      ...
      (val_sub, ":days", 1),
      (troop_set_slot, "$g_cur_horse_merchant", slot_troop_horse_train_days_left, ":days"),
      (try_begin),
        (eq, ":days", 0),
          (troop_get_slot, ":horse", "$g_cur_horse_merchant", slot_troop_horse_train_cur_horse),
          (str_store_item_name, s1, ":horse"),
          (store_sub, ":cur_town", "$g_cur_horse_merchant", horse_merchants_begin),
          (val_add, ":cur_town", towns_begin),
          (str_store_party_name, s2, ":cur_town"),
