...
for i in xrange(len(CSTM_SKINS)):
    ...
    [
        ...
        # (assign, "$g_cstm_do_once_1", 1),
        # (call_script, "script_initialize_faction_troop_types_player"),
        ############## disable in v1.8 - change must be gradual
...
customise_troops_town_option = ("cstm_customise_troop", [(eq, "$g_player_court", "$current_town")], "Customize your kingdom's troops.",
    [
        (try_begin),
...
def modmerge(var_set):
    ...
    menus["town"].insert_option_after(customise_troops_town_option, "castle_wait") ####### NEW v2.5
