...
["walk_forward_crouch", acf_parallels_for_look_slope|acf_anim_length(100), 0,
 ...
 # ["walk_forward_crouch", acf_parallels_for_look_slope|acf_anim_length(100),
   # [10.0, "low_walk", 1, 81, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 # ],
 # ["stand_to_crouch", acf_enforce_lowerbody|acf_parallels_for_look_slope,
   # [5.0, "crouch_down", 1, 81, arf_cyclic, pack2f(0.4,0.9), (0, 0, 0), 0.0],
 # ],
 # ["crouch_to_stand", acf_enforce_lowerbody,
   # [1.7, "crouch_down", 154, 185, arf_blend_in_1, 0, (0, 0, 0), 0.0],
 # ],
...
##   [0.6, "anim_human", combat+7334, combat+7340, blend_in_release], 
   [0.45, "attacks_staff_thrust", 40, 58, blend_in_release], 
 ],
...
#   [defend_duration, "defend_shield_parry_all", 5, 26, blend_in_defense], 
 ...
 ["defend_shield_keep", acf_parallels_for_look_slope|acf_anim_length(100), amf_rider_rot_shield|amf_priority_defend|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   #[defend_keep_duration, "anim_human", defend+118, defend+120, arf_blend_in_4|arf_cyclic], #tom 
   #[defend_keep_duration, "1257_shield3", 35118, 35120, arf_blend_in_4|arf_cyclic], 
   [defend_keep_duration, "shield3", 6, 6, arf_blend_in_4|arf_cyclic], 
 ],
...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3], 
 ...
 ["fall_chest_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   ########## NEW v1.8
   [2.1, "new_death_3", 0, 45, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.9), (0, 0, 0), 1.6],
 ],
 ["fall_abdomen_hold_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   ########## NEW v1.8
   [2.5, "new_death_7", 0, 194, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.4), (0, 0, 0), 2.35],
 ],
...
########## NEW v1.8
   [2.2, "new_death_crawl", 0, 109, arf_blend_in_10|arf_make_custom_sound, pack2f(0.82, 0.47), (0, 0, 0), 2.19],
 ],
########## NEW v2.1 - new horseman death animations
...
["shield_strike", acf_enforce_all|acf_align_with_ground, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
 ...
 ["spearwall_hold", acf_thrust|acf_enforce_all|acf_align_with_ground, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
  ...
  ["sit_drink", acf_enforce_all, amf_accurate_body,
   [3.0, "sit_drink", 0, 2, arf_cyclic, 0, (0, 0, 0), 0.25],
   ],
