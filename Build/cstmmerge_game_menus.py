...
# start_as_king_background_option = ("cstm_start_king", [], "An adventurer who became a king.", [
    ...
    # fed up with this life, he struck out for adventure in the war-torn land of Europe, leaving you and your mother\
    ...
    # (store_random_in_range, ":player_gold", 50000, 80000),
    # (call_script, "script_troop_add_gold", "trp_player", ":player_gold"),
...
# player_kingdom_starting_fiefs = [
   ##################################################### Portugal
    # "p_town_16_1",        ############## Lisboa
    # "p_town_16_2",        ############## Coimbra
    # "p_castle_16_1",    ############## Derchios Castle
    # "p_castle_16_2",    ############## Reindi Castle
    # "p_castle_16_3",    ############## Senuzgda Castle
    # "p_castle_16_4",    ############## Rindyar Castle
# ]
...
# start_as_king_background_option[3].extend([
    ...
    #####################################################SET CENTER CAPITAL TO PLAYER CULTURE
    # (party_set_slot, capital, slot_center_culture, fac_culture_player),
...
# start_as_king_background_option[3].extend([
    ...
    # (try_for_range, ":center", centers_begin, centers_end),
        ...
        #####################################################SET CENTER CULTURE TO PLAYER CULTURE
        # (party_set_slot, ":center", slot_center_culture, fac_culture_player),
