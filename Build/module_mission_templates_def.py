...
########################################################
        (try_begin),
          (this_or_next|is_between, ":handone", "itm_bamboo_spear", "itm_staff"),
          (is_between, ":handtwo", "itm_bamboo_spear", "itm_staff"),
            (assign, ":continue",1),
            (try_begin),
              (this_or_next|eq, ":handone", "itm_bamboo_spear"),
              (eq, ":handtwo", "itm_bamboo_spear"),
              (assign, ":speardist", 200),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_a"),
              (eq, ":handtwo", "itm_spear_a"),
              (assign, ":speardist", 156),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_b"),
              (eq, ":handtwo", "itm_spear_b"),
              (assign, ":speardist", 155),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_c"),
              (eq, ":handtwo", "itm_spear_c"),
              (assign, ":speardist", 135),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_d"),
              (eq, ":handtwo", "itm_spear_d"),
              (assign, ":speardist", 143),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_e"),
              (eq, ":handtwo", "itm_spear_e"),
              (assign, ":speardist", 142),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_f"),
              (eq, ":handtwo", "itm_spear_f"),
              (assign, ":speardist", 146),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_g"),
              (eq, ":handtwo", "itm_spear_g"),
              (assign, ":speardist", 142),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_h"),
              (eq, ":handtwo", "itm_spear_h"),
              (assign, ":speardist", 145),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_i"),
              (eq, ":handtwo", "itm_spear_i"),
              (assign, ":speardist", 141),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_j"),
              (eq, ":handtwo", "itm_spear_j"),
              (assign, ":speardist", 170),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_k"),
              (eq, ":handtwo", "itm_spear_k"),
              (assign, ":speardist", 160),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_l"),
              (eq, ":handtwo", "itm_spear_l"),
              (assign, ":speardist", 170),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_m"),
              (eq, ":handtwo", "itm_spear_m"),
              (assign, ":speardist", 160),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_n"),
              (eq, ":handtwo", "itm_spear_n"),
              (assign, ":speardist", 175),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_o"),
              (eq, ":handtwo", "itm_spear_o"),
              (assign, ":speardist", 150),
            (else_try),
              (this_or_next|eq, ":handone", "itm_spear_p"),
              (eq, ":handtwo", "itm_spear_p"),
              (assign, ":speardist", 160),
            (try_end),
		############## NEW v3.9 - fixed cwe spears not being taken into account when dealing with spear bracing
        (else_try),
          (this_or_next|is_between, ":handone", "itm_crusader_spear_a", "itm_mace_6"),
          (is_between, ":handtwo", "itm_crusader_spear_a", "itm_mace_6"),
            (assign, ":continue",1),
            (try_begin),
              (this_or_next|eq, ":handone", "itm_crusader_spear_a"),
              (eq, ":handtwo", "itm_crusader_spear_a"),
              (assign, "$spear_dist", 180),
            (else_try),
              (this_or_next|eq, ":handone", "itm_crusader_spear_b"),
              (eq, ":handtwo", "itm_crusader_spear_b"),
              (assign, "$spear_dist", 175),
            (else_try),
              (this_or_next|eq, ":handone", "itm_crusader_spear_c"),
              (eq, ":handtwo", "itm_crusader_spear_c"),
              (assign, "$spear_dist", 170),
            (else_try),
              (this_or_next|eq, ":handone", "itm_crusader_spear_inf_a"),
              (eq, ":handtwo", "itm_crusader_spear_inf_a"),
              (assign, "$spear_dist", 155),
            (else_try),
              (this_or_next|eq, ":handone", "itm_crusader_spear_inf_b"),
              (eq, ":handtwo", "itm_crusader_spear_inf_b"),
              (assign, "$spear_dist", 160),
            (else_try),
              (this_or_next|eq, ":handone", "itm_crusader_spear_inf_c"),
              (eq, ":handtwo", "itm_crusader_spear_inf_c"),
              (assign, "$spear_dist", 175),
            (else_try),
              (this_or_next|eq, ":handone", "itm_saracin_spears_a"),
              (eq, ":handtwo", "itm_saracin_spears_a"),
              (assign, "$spear_dist", 165),
            (else_try),
              (this_or_next|eq, ":handone", "itm_saracin_spears_a_v_1"),
              (eq, ":handtwo", "itm_saracin_spears_a_v_1"),
              (assign, "$spear_dist", 125),
            (else_try),
              (this_or_next|eq, ":handone", "itm_mameluk_spears_a"),
              (eq, ":handtwo", "itm_mameluk_spears_a"),
              (assign, "$spear_dist", 185),
            (else_try),
              (this_or_next|eq, ":handone", "itm_mameluk_spears_b"),
              (eq, ":handtwo", "itm_mameluk_spears_b"),
              (assign, "$spear_dist", 185),
            (else_try),
              (this_or_next|eq, ":handone", "itm_mameluk_spears_c"),
              (eq, ":handtwo", "itm_mameluk_spears_c"),
              (assign, "$spear_dist", 185),
            (try_end),
        ############################
		############## NEW v3.9 - added bills, halberds, etc to spear bracing
        (else_try),
          (this_or_next|is_between, ":handone", "itm_modded_billhook_fork_1", "itm_maul"),
          (is_between, ":handtwo", "itm_modded_billhook_fork_1", "itm_maul"),
            (assign, ":continue",1),
            (try_begin),
              (this_or_next|eq, ":handone", "itm_modded_billhook_fork_1"),
              (eq, ":handtwo", "itm_modded_billhook_fork_1"),
                (assign, "$spear_dist", 198),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_billhook_fork_2"),
              (eq, ":handtwo", "itm_modded_billhook_fork_2"),
              (assign, "$spear_dist", 198),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_fauchard_1"),
              (eq, ":handtwo", "itm_modded_fauchard_1"),
              (assign, "$spear_dist", 186),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_fauchard_2"),
              (eq, ":handtwo", "itm_modded_fauchard_2"),
              (assign, "$spear_dist", 171),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_fauchard_3"),
              (eq, ":handtwo", "itm_modded_fauchard_3"),
              (assign, "$spear_dist", 197),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_fauchard_4"),
              (eq, ":handtwo", "itm_modded_fauchard_4"),
              (assign, "$spear_dist", 200),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_glaive_1"),
              (eq, ":handtwo", "itm_modded_glaive_1"),
              (assign, "$spear_dist", 169),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_glaive_fork_1"),
              (eq, ":handtwo", "itm_modded_glaive_fork_1"),
              (assign, "$spear_dist", 230),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_glaive_fork_2"),
              (eq, ":handtwo", "itm_modded_glaive_fork_2"),
              (assign, "$spear_dist", 188),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_glaive_roundel"),
              (eq, ":handtwo", "itm_modded_glaive_roundel"),
              (assign, "$spear_dist", 149),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_bill_1"),
              (eq, ":handtwo", "itm_modded_bill_1"),
              (assign, "$spear_dist", 215),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_bill_2"),
              (eq, ":handtwo", "itm_modded_bill_2"),
              (assign, "$spear_dist", 231),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_billhook_1"),
              (eq, ":handtwo", "itm_modded_billhook_1"),
              (assign, "$spear_dist", 207),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_billhook_2"),
              (eq, ":handtwo", "itm_modded_billhook_2"),
              (assign, "$spear_dist", 172),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_billhook_3"),
              (eq, ":handtwo", "itm_modded_billhook_3"),
              (assign, "$spear_dist", 152),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_voulge"),
              (eq, ":handtwo", "itm_modded_voulge"),
              (assign, "$spear_dist", 200),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_spiked_voulge"),
              (eq, ":handtwo", "itm_modded_spiked_voulge"),
              (assign, "$spear_dist", 182),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_cleaving_voulge"),
              (eq, ":handtwo", "itm_modded_cleaving_voulge"),
              (assign, "$spear_dist", 152),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_hooked_voulge_1"),
              (eq, ":handtwo", "itm_modded_hooked_voulge_1"),
              (assign, "$spear_dist", 192),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_hooked_voulge_2"),
              (eq, ":handtwo", "itm_modded_hooked_voulge_2"),
              (assign, "$spear_dist", 186),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_hooked_voulge_3"),
              (eq, ":handtwo", "itm_modded_hooked_voulge_3"),
              (assign, "$spear_dist", 192),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_couteau_1"),
              (eq, ":handtwo", "itm_modded_couteau_1"),
              (assign, "$spear_dist", 177),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_couteau_2"),
              (eq, ":handtwo", "itm_modded_couteau_2"),
              (assign, "$spear_dist", 196),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_guisarme"),
              (eq, ":handtwo", "itm_modded_guisarme"),
              (assign, "$spear_dist", 232),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_assegai"),
              (eq, ":handtwo", "itm_modded_assegai"),
              (assign, "$spear_dist", 231),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_pike"),
              (eq, ":handtwo", "itm_modded_pike"),
              (assign, "$spear_dist", 300),
            (else_try),
              (this_or_next|eq, ":handone", "itm_modded_war_spear"),
              (eq, ":handtwo", "itm_modded_war_spear"),
              (assign, "$spear_dist", 211),
            (try_end),
########################################################
        (else_try),
          (this_or_next|is_between, ":handone", "itm_military_fork", "itm_light_lance"),
          (is_between, ":handtwo", "itm_military_fork", "itm_light_lance"),
            (assign, ":continue",1),
            (try_begin),
              (this_or_next|eq, ":handone", "itm_military_fork"),
              (eq, ":handtwo", "itm_military_fork"),
                (assign, "$spear_dist", 135),
            (else_try),
              (this_or_next|eq, ":handone", "itm_battle_fork"),
              (eq, ":handtwo", "itm_battle_fork"),
                (assign, "$spear_dist", 142),
            (else_try),
              (this_or_next|eq, ":handone", "itm_glaive"),
              (eq, ":handtwo", "itm_glaive"),
                (assign, "$spear_dist", 160),
            (else_try),
              (this_or_next|eq, ":handone", "itm_military_scythe"),
              (eq, ":handtwo", "itm_military_scythe"),
                (assign, "$spear_dist", 153),
            (else_try),
              (this_or_next|eq, ":handone", "itm_bill"),
              (eq, ":handtwo", "itm_bill"),
...
########################################################
           ...
           # (display_message, "@{s20}'s horse receives {reg1} damage from {s21}'s braced polearm! speed {reg22}",info_clr),
